...
export function SkillIconsDartDark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <g fill="none">
        ...
        <path
          fill="#0075c9"
          d="M169.906 76.447c-2.165-.549-4.241-.895-6.111-.948l-4.157-.152l-83.827.02l116.415 116.398l10.227-23.063l-32.541-92.25z"
        ></path>
        <path
          fill="#00a8e1"
